...
void ABonusBase::BeginPlay()
{
    ...
    if(mBonusIdleShining){
        ...
        UGameplayStatics::SpawnEmitterAttached(mBonusIdleShining, skMeshBonus, TEXT("idleShining"), FVector(0,0,130), FRotator(-90,0,90), EAttachLocation::KeepRelativeOffset);
    }
}
